...
//namespace Lily.Core.Infrastructure.Persistence.DocumetDb
//{
...
//        public async Task<List<T>> GetAll(string username)
//        {
//            await Initialize();
//            return await Get(username, t => true);
//        }

//        public async Task<List<T>> Get(string username, Expression<Func<T, bool>> predicate)
//        {
//            await Initialize();
...
//        protected async Task<IEnumerable<T>> Get(Expression<Func<T, bool>> predicate)
//        {
//            await Initialize();
//            return _client.CreateDocumentQuery<T>(CreateCollectionUri(),
